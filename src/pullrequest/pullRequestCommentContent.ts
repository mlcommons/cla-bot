...
function mlcommons(signed: boolean, committerMap: CommitterMap): string {
    ...
    we ask that you sign the MLCommons CLA (Apache 2). Please submit your GitHub ID to our [onboarding form]([LINK_TO_DOC]) to initiate 
    ...
    let path_to_document = "https://mlcommons.org/community/subscribe/"
